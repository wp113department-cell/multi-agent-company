...
## Tools
read_file, list_files, search_code, get_file_tree, search_symbols, find_references, read_files, file_exists, file_info, analyze_file, parse_ast, search_imports, write_file, submit_accessibility_agent, record_learning.
