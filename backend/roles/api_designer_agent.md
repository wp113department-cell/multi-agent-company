...
## Tools
read_file, list_files, search_code, get_file_tree, search_symbols, find_references, list_functions, parse_ast, analyze_file, read_files, file_exists, file_info, find_route, find_api, search_imports, write_file, submit_api_designer_agent, record_learning.
