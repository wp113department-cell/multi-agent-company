...
## Tools
read_file, list_files, search_code, get_file_tree, search_symbols, find_references, list_functions, parse_ast, analyze_file, read_files, file_exists, file_info, git_log, git_diff, git_show, git_status, find_todos, search_imports, write_file, submit_rollback_agent, record_learning.
